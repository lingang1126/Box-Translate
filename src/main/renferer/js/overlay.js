...
closeIcon.addEventListener('mouseover', () => { showCloseButton(); });
closeIcon.addEventListener('mouseleave', () => { hideCloseButton(); });
selectArea.addEventListener('mouseover', () => { showCloseButton(); });
selectArea.addEventListener('mouseleave', () => { hideCloseButton(); });

// 显示和隐藏 closeButton 
const showCloseButton = () => { closeIcon.style.display = 'block'; };
const hideCloseButton = () => { closeIcon.style.display = 'none'; };
